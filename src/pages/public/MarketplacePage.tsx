...
function ProductOrExperienceCard({ item }: MarketplaceCardProps) {
  ...
  return (
    <Card className="group flex h-full flex-col justify-between overflow-hidden border-ink-200/80 bg-white p-0 shadow-xs transition-all duration-300 hover:-translate-y-1.5 hover:border-clay-300 hover:shadow-xl">
      <div>
        {/* Cover Image Banner */}
        ...
        <div className="p-5 space-y-3">
          ...
          <div>
            ...
            <p className="mt-1 text-xs sm:text-sm text-ink-600 leading-relaxed line-clamp-2">
    ...
    <div className="space-y-10 pb-16">
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="inline-flex rounded-2xl bg-white p-1.5 border border-ink-200 shadow-xs">
            <button
              type="button"
          ...
          {/* District selector */}
          <div className="flex items-center gap-2 rounded-2xl bg-white px-4 py-2 border border-ink-200 shadow-xs">
