        ...
        <div className="p-6 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-baseline gap-1">
              ...
              {stay.price != null && stay.price > 0 ? (
                <span className="text-xs font-medium text-ink-600">/ night</span>
              ) : null}
            </div>
            <span className="inline-flex items-center gap-1 text-[11px] font-semibold text-forest-900 bg-forest-100/90 px-2 py-0.5 rounded-md border border-forest-300/60">
          ...
          <div>
            ...
            <p className="mt-1.5 text-xs sm:text-sm text-ink-700 leading-relaxed line-clamp-2">
          ...
          <div className="space-y-1.5 pt-3 border-t border-ink-100">
            {amenities.slice(0, 3).map((amenity) => (
              <div key={amenity} className="flex items-center gap-2 text-xs text-ink-700">
                <Check className="h-3.5 w-3.5 text-forest-700 shrink-0" />
                <span>{amenity}</span>
              </div>
            ))}
          </div>
