          ...
          {loading ? (
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              <Button
                ...
                className="hidden sm:inline-flex text-xs text-ink-700 hover:text-ink-950 hover:bg-sand/70 whitespace-nowrap"
              >
                Logout
              </Button>
            </div>
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              <Link
                to="/login"
                className="inline-flex items-center gap-1.5 rounded-full px-3 sm:px-3.5 py-1.5 text-xs font-bold bg-clay-700 text-white hover:bg-clay-800 shadow-xs transition-all duration-150 whitespace-nowrap shrink-0"
              >
      ...
      {mobileMenuOpen && (
        <div className="border-t border-ink-200/80 bg-[#F7F3EA] px-4 py-5 lg:hidden animate-in fade-in slide-in-from-top-2 duration-200 shadow-2xl text-ink-900 max-h-[calc(100vh-4rem)] overflow-y-auto">
          <div className="flex flex-col gap-4">
            {/* Top Prominent Auth / Profile Card for Mobile */}
            <div className="rounded-2xl border border-ink-200/90 bg-white/90 p-4 shadow-xs">
              {user ? (
                <div className="space-y-3">
                  <div className="flex items-center justify-between gap-2">
                    <div className="min-w-0">
                      <p className="text-[10px] font-bold uppercase tracking-wider text-clay-700">Signed In As</p>
                      <p className="truncate text-xs font-bold text-ink-900">{profile?.full_name ?? user.email}</p>
                    </div>
                    <Badge variant="accent" className="capitalize text-[10px] shrink-0">{role}</Badge>
                  </div>
                  <div className="grid grid-cols-2 gap-2 pt-1">
                    <Button
                      ...
                      className="bg-forest-900 text-white hover:bg-forest-800 font-bold text-xs w-full"
                    >
                      <Link to={getDashboardPathForRole(role)}>Dashboard</Link>
                    </Button>
                    <Button
                ...
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-ink-900">Welcome, Traveller</span>
                    <span className="text-[10px] font-semibold text-clay-700">Jharkhand Diaries</span>
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <Button
                      ...
                      size="sm"
                      onClick={() => setMobileMenuOpen(false)}
                      className="bg-clay-700 text-white hover:bg-clay-800 font-bold text-xs w-full"
                    >
            ...
            <div className="flex items-center justify-between px-3.5 py-2.5 bg-white/70 rounded-2xl border border-ink-200/80">
